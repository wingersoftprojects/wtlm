...
@ManagedBean
@RequestScoped
public class Task_categoryBean1 {
    ...
    public List<Task_category> getTask_categorys() throws Exception {
        ...
        try (
            ...
            while (rs.next()) {
                Task_category sc = new Task_category();
                this.setTask_categoryFromResultset(sc, rs);
                task_categorys.add(sc);
            }
        } catch (SQLException se) {
            se.printStackTrace();
        }
